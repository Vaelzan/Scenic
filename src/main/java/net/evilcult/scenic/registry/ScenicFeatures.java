...
public class ScenicFeatures {
    ...
    public static final RegistryObject<Feature<RockPileConfig>> ROCK_PILE_FEATURE = register("rock_pile", new RockPileFeature(RockPileConfig::deserialize));
    public static final RegistryObject<Feature<RockPileConfig>> SANDSTONE_ROCK_PILE_FEATURE = register("sandstone_rock_pile", new RockPileFeature(RockPileConfig::deserialize));
