...
public class ScenicBiomeFeatures {
    ...
    public static final BlockClusterFeatureConfig STALAGMITE_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(STALAGMITE), new SimpleBlockPlacer())).tries(32).whitelist(ImmutableSet.of(STONE.getBlock())).func_227317_b_().build();
    public static final BlockClusterFeatureConfig STALACTITE_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(STALACTITE), new SimpleBlockPlacer())).tries(32).func_227317_b_().build();  //.whitelist(ImmutableSet.of(STONE.getBlock())) // (doesn't work with this placer, the whitelist checks below not above)
